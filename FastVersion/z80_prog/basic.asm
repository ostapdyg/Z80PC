...
LF1      .EQU    0AH             ; Line feed
CS1      .EQU    0CH             ; Clear screen
CR1      .EQU    0DH             ; Carriage return
...
INIT1:   LD      DE,INITAB       ; Initialise workspace
...
MRPRNT: DEC     HL              ; DEC 'cos GETCHR INCs
        CALL    GETCHR          ; Get next character
PRINT1:  JP      Z,PRNTCRLF      ; CRLF if just PRINT
